...
public class SubCommandExcample implements Runnable{
    @Override
    public void run() {
    ...
    @Command(name = "query", description = "增加", mixinStandardHelpOptions = true)
...
//        String[] myArgs = new String[]{"add","--help"};
        ...
        int exitCode = new CommandLine(new SubCommandExcample())
